...
export const Checkbox: React.FC<CheckboxBlockProps> = (props) => {
  ...
  const label = shape.label ?? "Checkbox";
  const checked = !!shape.checked;
  const boxBg = checked ? shape.color ?? "#3B82F6" : "#ffffff";
  const boxBorder = "1px solid rgba(0,0,0,0.25)";
      ...
      >
        ...
        >
          <svg width="12" height="12" viewBox="0 0 20 20">
            <path
              d="M7.5 13.5l-3-3 1.4-1.4 1.6 1.6 5-5 1.4 1.4-6.4 6.4z"
              fill="currentColor"
            />
          </svg>
        </div>
