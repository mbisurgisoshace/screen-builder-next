...
export const AdditionalDecisionMaker: React.FC<CustomerProps> = (props) => {
      ...
      >
        <div className="p-6 pt-0">
          <div className="mb-4">
            <textarea
              ref={textareaRef}
              placeholder={"Type Additional Decision Maker here.."}
            ...
            {isEmpty ? (
              ...
              <RteEditor
                ...
                editorClassName={`px-2 pt-0 pb-2 min-h-[120px] text-[14px] mt-0 font-manrope  font-medium text-[#2E3545] ${
                  editingBody ? "bg-[#E0FAF2] rounded" : "bg-transparent"
                }`}
