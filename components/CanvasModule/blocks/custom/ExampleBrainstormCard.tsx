...
type ExampleBrainstormProps = Omit<ShapeFrameProps, "children" | "shape"> & {
  shape: IShape;
...
export const ExampleBrainstormCard: React.FC<ExampleBrainstormProps> = (
  props
) => {
